...
window.PAPUA_RITUAL = {
  ...
  correct: [
    { item: 'clayFat',
      ...
      say:  'ถูกแล้ว ทาโคลนแดงผสมไขมันให้ทั่วร่างก่อน อากาศและแมลงจะเข้าไม่ถึง' },
    { item: 'torch',
  ...
  early: [
    'ยังก่อน ต้องทาโคลนแดงให้ทั่วร่างเสียก่อน',
    'อย่าเพิ่งจุดไฟ ร่างยังไม่ได้ทาโคลนเลย ไฟจะทำให้เสียของ'
  ],
