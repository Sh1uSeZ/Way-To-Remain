...
window.ROIET_RITUAL = {
  ...
  correct: [
    { item: 'tobacco',
      ...
      under: 'corpse',   /* ใบยาสูบรองอยู่ใต้ร่าง ไม่ได้วางทับ */
  ...
  /* ของถูกแต่ยังไม่ถึงคิว ต้องปูใบยาสูบรองก่อนค่อยโรยปูนขาวทับ */
  early: [
    'ใจเย็นก่อน ต้องเอาใบยาสูบรองใต้ร่างก่อนเด้อ',
    'ปูใบยาสูบรองให้เรียบร้อยก่อน ค่อยโปรยปูนขาวทับทีหลัง'
  ],
